...
//		vec3 col7 = ab7.rgb;
		...
		vec4 rough_1 = vec4(nr4.a, nr5.a, 0, 0); //nr6.a, nr7.a);
...
//		vec3 normal7 = unpack_normal(nr7);
		...
		if (u_depth_blending) {
			...
			vec4 bumps_1 = vec4(ab4.a, ab5.a, 0, 0); // ab6.a, ab7.a);
			//w_0 = get_depth_blended_weights(v_splat_0, bumps_0);
			...
			w_1.r -= max(h_1.g, h_max_0); //max(h_1.b, max(h_1.a, h_max_0)));
			w_1.g -= max(h_1.r, h_max_0); //max(h_1.b, max(h_1.a, h_max_0)));
...
//			w_1.a -= max(h_1.g, max(h_1.b, max(h_1.r, h_max_0)));
	...
	//    if (w_1.r > w_1.g) ALBEDO = v_tint.rgb * col5.rgb;
	//	else ALBEDO = v_tint.rgb * col2.rgb;
		ALBEDO = v_tint.rgb * (
			w_0.r * col0.rgb +
			w_0.g * col1.rgb +
			w_0.b * col2.rgb +
